...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
	  ...
	  <div class="content-wrapper">
	        ...
	        <div class="col-xs-12">
		          <div class="box">
		            <div class="box-header">
		              <h4 class="box-title">Camiseta Azul</h4>
		              
		              <div>
		              <img src="assets/img/Produtos/Azul1.jpg" align="left" height="40%" width="40%">
		              <img src="assets/img/Produtos/Azul2.jpg" align="middle" height="40%" width="40%">
	    ...
	    <span class="input-group-btn">
	    <button type="button" class="btn btn-info" id="prox2">Próximo </button>
	    </span>
	...
	$("#voltar").click(function() {
		window.location.href = "descricaoProd.jsp"
	});
	
	$("#prox2").click(function() {
		window.location.href = "produto2.jsp"
	});
